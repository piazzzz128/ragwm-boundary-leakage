...
SCORES_PATH = Path("/root/autodl-tmp/ragwm_storage/output/semantic_cliff/nfcorpus_strict_contriever_cosine_scores.json")
METRICS_PATH = Path("/root/autodl-tmp/ragwm_storage/output/semantic_cliff/nfcorpus_strict_contriever_cosine_metrics.json")
...
def main():
    ...
    # clean boundary tends to have higher continuity, inject boundary tends to lower continuity
    # so anomaly score = -cosine, label 1 = inject
    scores = -cosine
