...
from e2_common import norm_space, read_jsonl, write_json_atomic
...
def main() -> None:
    ...
    summary = {
        "note": "Ground truth is used only after attack completion for audit, never for selection.",
        ...
        "document_precision": tp / (tp + fp) if tp + fp else None,
        "document_recall": tp / (tp + fn) if tp + fn else None,
    ...
    print("POSTHOC GROUND-TRUTH AUDIT PASS")
